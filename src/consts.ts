 ...
 *
 * 陣列順序是「預設」順序，依使用時機排；首頁與工具箱的卡片載入後會再依
 * 近 30 天的實際使用次數重排（最多人用的在左上角），詳見 components/ToolGrid.astro。
 * 還沒有人用過的工具會照這裡的順序排在後面，所以新工具放哪裡還是有差。
 */
/**
 * 工具的版本制度
 *
...
export const TOOLS = [
  ...
  },
  {
    ...
    time: '約 1 分鐘',
    summary:
      '今天哪裡發生雪崩？哪個跳台結冰有人受傷？填雪場、時間與事件內容就送得出去，馬上變成下面的卡片；出發前也可以先上來看看最近哪個雪場有狀況。',
    who: '剛從雪場回來想提醒大家的人，或想先知道最近哪裡出狀況的人',
  },
] as const;
